...
namespace AbstractGeometry
{
	internal class IsoscalesTriangle : Triangle
	{
		...
		{
			get => triangleBase; set => triangleBase = SizeFilter(value);
		}
		...
		public IsoscalesTriangle(double triangleBase, double triangleSide,int startX, int startY, int lineWidth,
			Color color) : base(startX, startY, lineWidth, color)
		{
		...
		public override double GetArea() =>
			TriangleBase * GetHeight() / 2;
		public override double GetPerimeter() =>
			TriangleBase + TriangleSide * 2;
