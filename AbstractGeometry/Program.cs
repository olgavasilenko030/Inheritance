...
namespace AbstractGeometry
{
	internal class Program
	{
		static void Main(string[] args)
		{
			...
			Circle circle = new Circle(75, 570, 95, 5, Color.Yellow);
			circle.Info(e);
			IsoscalesTriangle i_triangle = 
				new IsoscalesTriangle(50, 100, 700, 50,8, Color.Green);
			i_triangle.Info(e);

			EguilateralTriangle e_triangle =
				new EguilateralTriangle(150, 500, 200, 5, Color.GreenYellow);
			e_triangle.Info(e);
		}
